...
for TracingEfficiencyValueNumber = 1:linspace
    ...
    for TestSensitivityValueNumber =1:linspace
        ...
        for ExperimentNumber = 1:NumberOfExperiments
            ...
            if NumberOfInfected < MaximumAllowedInfected
                ...
                avgProportionTraced += totalChildrenTraced/(MaximumAllowedInfected-InitialNumberOfInfected)/NumberOfExperiments
            end

            if totalChildrenTraced + nonvalidtracings != 0
                PTraceValidArrayexp += totalChildrenTraced/(totalChildrenTraced+nonvalidtracings)
                nExpWithTracings += 1
            end
            ...
            averageDayofInfectionGivenTracing += sumInfectiontimeGivenTracing/totalChildrenTraced/NumberOfExperiments
            avgnumbertraced += totalChildrenTraced/NumberOfExperiments
            avgProportionTraced += totalChildrenTraced/(NumberOfInfected-InitialNumberOfInfected)/NumberOfExperiments
        ...
        for test in 1:Nuntrace
            randomVariable += 2*drawLognormallyDistributedInteger();
        ...
        randomVariable /= Nuntrace
        print("Average random variable:\t", randomVariable, "\n")
        ...
        print("\nEffective Reff after simulation:\t",EffectiveReproductionNumber_AveragedOverExperiments,"\n");

        empiricalMean[TestSensitivityValueNumber, TracingEfficiencyValueNumber] = EffectiveReproductionNumber_AveragedOverExperiments
        theoreticalMeanArray[TestSensitivityValueNumber, TracingEfficiencyValueNumber] = theoreticalMean
